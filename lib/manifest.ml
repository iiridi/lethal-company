...
let pack version_number =
  ...
  ; dependencies =
      (let d = Dependency.dep in
       ...
       ; d "HomelessGinger" "MaskedEnemyOverhaul" (v 2 2 1)
       ; d "IntegrityChaos" "Diversity" (v 1 1 8)
       ; d "itsmeowdev" "DoorFix" (v 1 0 0)
       ; d "Jamil" "Corporate_Restructure" (v 1 0 5)
       ; d "Jordo" "NeedyCats" (v 1 1 1)
       ; d "JunLethalCompany" "GamblingMachineAtTheCompany" (v 1 1 2)
       ...
       ; d "MrHydralisk" "EnhancedLockpicker" (v 1 1 2)
       ; d "MrHydralisk" "EnhancedRadarBooster" (v 1 5 1)
       ; d "mrov" "LethalRichPresence" (v 0 5 2)
       ...
       ; d "quackandcheese" "MirrorDecor" (v 1 2 2)
       ...
       ; d "scoopy" "Scoopys_Variety_Mod" (v 0 5 1)
