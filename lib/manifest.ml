...
let pack version_number =
  ...
  ; dependencies =
      (let d = Dependency.dep in
       ...
       ; d "AbyssalCompanyTeam" "AbyssalAudio" (v 1 3 0)
       ...
       ; d "bigmcnugget" "VanillaContentExpansion" (v 0 1 4)
       ...
       ; d "Clementinise" "CustomSounds" (v 2 3 0)
       ; d "darmuh" "darmuhsTerminalStuff" (v 2 2 2)
       ; d "darmuh" "ghostCodes" (v 1 5 0)
       ...
       ; d "HomelessGinger" "MaskedEnemyOverhaul" (v 3 0 0)
       ...
       ; d "loaforc" "FacilityMeltdown" (v 1 2 3)
       ...
       ; d "Regis" "ImmersiveCompany" (v 0 2 5)
       ...
       ; d "ShaosilGaming" "GeneralImprovements" (v 1 0 20)
