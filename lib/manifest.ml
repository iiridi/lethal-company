...
let pack version_number =
  ...
  ; dependencies =
      (let d = Dependency.dep in
       ...
       ; d "bigmcnugget" "VanillaContentExpansion" (v 0 1 6)
       ...
       ; d "CapyCat" "Solos_Bodycams" (v 1 0 5)
       ; d "CHILLAX" "ChillaxSCRAPS" (v 0 6 0)
       ; d "Clementinise" "CustomSounds" (v 2 3 1)
       ; d "darmuh" "darmuhsTerminalStuff" (v 2 2 3)
       ; d "darmuh" "ghostCodes" (v 1 5 1)
       ; d "Dev1A3" "ScannableCodes" (v 1 0 2)
       ; d "Dreamweave" "CompanyBuildingEnhancements" (v 2 6 0)
       ; d "e3s1" "BetterLadders" (v 1 4 0)
       ...
       ; d "HomelessGinger" "MaskedEnemyOverhaul" (v 3 1 0)
       ...
       ; d "JunLethalCompany" "GamblingMachineAtTheCompany" (v 1 3 5)
         (* ; d "KayNetsua" "E_Gypt_Moon" (v 2 0 8) *)
       ...
       ; d "mrov" "LethalRichPresence" (v 0 5 6)
       ...
       ; d "Rune580" "LethalCompany_InputUtils" (v 0 5 5)
       ; d "scoopy" "Scoopys_Variety_Mod" (v 0 6 5)
       ; d "SillySquad" "TakeThatMaskOff" (v 1 3 0)
       ; d "ShaosilGaming" "GeneralImprovements" (v 1 0 22)
