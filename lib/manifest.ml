...
let pack version_number =
  ...
  ; dependencies =
      (let d = Dependency.dep in
       ...
       ; d "bigmcnugget" "VanillaContentExpansion" (v 0 1 3)
       ...
       ; d "freesnow" "CollectYourDead" (v 1 0 1)
       ...
       ; d "kyxino" "LethalUtilities" (v 1 2 14)
       ; d "LeKAKiD" "SignalTranslatorAligner" (v 1 0 0)
       ; d "loaforc" "FacilityMeltdown" (v 1 2 1)
       ...
       ; d "PotatoePet" "AdvancedCompany" (v 1 0 109)
       ...
       ; d "RugbugRedfern" "Skinwalkers" (v 2 0 7)
       ; d "Rune580" "LethalCompany_InputUtils" (v 0 5 1)
       ; d "Sligili" "More_Emotes" (v 1 3 3)
       ; d "SillySquad" "TakeThatMaskOff" (v 1 2 0)
       ...
       ; d "ViViKo" "BunkbedRevive" (v 1 0 2)
