  ...
  ; dependencies =
      (let d = Dependency.dep in
       ...
       Team.
         ...
         ; d teamclark "TheMostLethalCOSMOS" (v 1 1 1)
         ...
         ; d splitface "LCSprayFix" (v 1 0 2)
         ; d anormaltwig "LateCompany" (v 1 0 9)
         ; d abyssalcompanyteam "AbyssalAudio" (v 1 1 2)
         ; d no00ob "LCSoundTool" (v 1 4 0)
         ; d clementinise "CustomSounds" (v 2 2 0)
         ; d dev1a3 "ScannableCodes" (v 1 0 0)
         ])
